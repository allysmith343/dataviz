...
.then(data => {
    ...
    paragraph.textContent = `There are ${countEuCities} cities in the EU. Each dot represents a city and is placed based on the actual location of that city in Europe. The cities with populations larger than a milliona are the larger dots and are labeled.`
